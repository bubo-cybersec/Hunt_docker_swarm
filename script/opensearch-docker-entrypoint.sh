...
function runOpensearch {
    ...
    echo "$email" | /usr/share/opensearch/bin/opensearch-keystore add opensearch.notifications.core.email.notification.username

    echo "$password" | /usr/share/opensearch/bin/opensearch-keystore add opensearch.notifications.core.email.notification.password
...
email="notification@bubo-cybersec.com"
password="az7KXRl1AVRgbJPDeHt3"

echo -e "$email" | /usr/share/opensearch/bin/opensearch-keystore add opensearch.notifications.core.email.notification.username
